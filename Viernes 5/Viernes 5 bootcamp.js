...
function stringBizarre(str) {
    let n = str.length;
    if (n >= 6) {
        return str.slice(n - 3) + str.slice(3, n - 3) + str.slice(0, 3);
    } else {
        return "La cadena debe tener más de 6 carácteres";
    }
}​
show(stringBizarre(str1));
